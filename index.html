  ...
  window.fbInit = async function(){
    try{
      ...
      if(fbQuotes.length > 0){
        // Merge with local — Firestore is source of truth
...
<aside class="sidebar">
  <div class="logo-area">
    ...
    <div>
      ...
      <div class="logo-sub">語言學校報價系統</div>
    </div>
  </div>
  ...
  <div class="sidebar-footer">
    <div class="sidebar-user" id="user-info" onclick="showUserSwitch()" style="cursor:pointer" title="點擊切換身份">
      <div class="user-avatar" id="user-avatar">顧</div>
      <div>
        <div class="user-name" id="user-name-display">放洋顧問</div>
        <div class="user-role" id="user-role-display">顧問・點擊切換</div>
      </div>
    </div>
  </div>
</aside>
      ...
      <div class="wizard-wrap">
        ...
        <div class="quote-panel">
          ...
          <div class="qp-footer">
            ...
            <button class="btn btn-pink" onclick="saveQuote()" id="btn-save" style="display:none">✓ 儲存報價</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="page" id="page-settings">
      <div class="page-wrap">
        ...
        <div class="settings-card" style="border:1.5px solid #bbf7d0">
          ...
          <div class="settings-card-sub">各學校回傭率（%），用於內部淨利試算，顧問與學生不可見</div>
        ...
        <div class="settings-card" style="border:1.5px solid #bae6fd">
          ...
          <div class="settings-card-sub">設定各學校期間限定折扣，顧問在報價時可選擇套用</div>
        ...
        <div class="settings-card">
          ...
          <div class="settings-card-sub">此資訊將顯示在匯出的 PDF 報價單上</div>
          <div class="form-row">
      ...
      <div class="history-wrap">
        ...
        <div class="toolbar">
          <div class="search-box">
            ...
            <input placeholder="搜尋學生姓名、學校、校區…" oninput="filterHistory(this.value)">
          </div>
    ...
    <div class="page" id="page-data">
      <div class="data-wrap">
        ...
        <div class="data-stats">
          <div class="stat-card"><div class="stat-num">3</div><div class="stat-label">已上線學校</div></div>
          <div class="stat-card"><div class="stat-num">48</div><div class="stat-label">校區數量</div></div>
          <div class="stat-card"><div class="stat-num">1,537</div><div class="stat-label">費用規則筆數</div></div>
        </div>
        <div class="tab-bar">
          <button class="tab-btn active">EP</button>
          <button class="tab-btn">ILSC</button>
          <button class="tab-btn">Kaplan</button>
          <button class="tab-btn" style="opacity:.45">IH</button>
          <button class="tab-btn" style="opacity:.45">BESA</button>
          <button class="tab-btn" style="opacity:.45">Winning</button>
        </div>
        <div class="coming-card">
          <div class="coming-icon">📂</div>
          <div class="coming-title">費用資料管理功能</div>
          <div class="coming-sub">此頁面用於新增、編輯各語言學校費用規則<br>IH、BESA、Winning 資料補入後將顯示於此<br><br>目前已載入：EP（10 校區）· ILSC（16 校區）· Kaplan（22 校區）</div>
        </div>
      </div>
    </div>
...
function exportPDF(mode='student'){
  ...
  // Total discount = school discount + company discount
  const totalDiscAmt = (calc.schoolDiscAmt||0) + (calc.discountAmt||0);
  const discRows = (!isInternal && totalDiscAmt > 0)
    ? `<tr>
        ...
        <td style="${tdStyle};font-weight:700;color:#10b981;text-align:right;border-top:1.5px solid #fce4f3">
          -NT$ ${totalDiscAmt.toLocaleString()}</td>
       </tr>` : '';
